...
Different configuration parameters to set in [`config/config.yml`](https://github.com/sylvainschmitt/climfor/blob/dev/config/config_ex.yml) ordered by steps:
...
-   Environment: [`dev-climfor.yml`](https://github.com/sylvainschmitt/climfor/blob/main/envs/dev-climfor.yml)
